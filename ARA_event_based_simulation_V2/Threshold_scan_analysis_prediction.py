...
TARGET_HZ = 2.5 #5.0            # target trigger rate
FIT_START_THRESHOLD = 42000 # choose where the exponential behavior starts

OUT_PNG = Path("Full_threshold_scan_long_ARA_data_test_modified_5Hz.png")
