...
N_of_channels = 8
THRESHOLD_V= [71692]*N_of_channels  # ADC^2 counts
...
benchmark_times = []  # To store benchmarking times
...
# Plot TOT vs SNR
plt.figure(figsize=(10, 6))
plt.scatter(tot_SNR_values, TOT_values, alpha=0.8)  
plt.title('Time Over Threshold (TOT) vs SNR for Triggered Events')
plt.xlabel('SNR', fontsize=14)
plt.ylabel('TOT (samples)', fontsize=14)
plt.grid()
