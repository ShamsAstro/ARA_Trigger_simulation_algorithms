...
N_of_channels = 8
THRESHOLD_V= [73296.5]*N_of_channels  # ADC counts
...
plt.title('ARA Trigger Efficiency Scan at 2.5Hz target threshold_ARA_like_pulse')
plt.xlabel('SNR')
plt.ylabel('Pass Fraction')
plt.grid()
plt.legend()
plt.savefig("Trigger_efficiency_scan_ARA_pulse_2_5HZ.png")
