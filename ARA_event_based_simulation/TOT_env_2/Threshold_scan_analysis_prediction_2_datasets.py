...
IN_JSON_B = Path("threshold_scan_rates_Eliminate_2_no_env.json")

labelA = "PURE noise"
labelB = "PURE noise, TOT>=2 samples, No env"
...
OUT_PNG = Path("trigger_rate_hz_vs_threshold_fit_compare_2tot_no_env.png")
# ------------------------------------------
