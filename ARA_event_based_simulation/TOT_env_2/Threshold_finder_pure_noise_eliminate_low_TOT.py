...
SCAN_TIME_LIMIT_SEC       = 60*3         #3600     # one hour
START_THRESHOLD           = 15000     # in POWER units (ADC^2), by your spec
THRESHOLD_STEP            = 1500     # increment per completed threshold
TRIGGERS_PER_THRESHOLD    = 10       # stop each threshold at n triggers
MIN_ALLOWED_TOT          = 2        # in samples (ns / TIME_STEP_NS), minimum TOT to consider a trigger valid
...
# Output file
OUT_JSON = Path("threshold_scan_rates_Eliminate_2_no_env.json")
